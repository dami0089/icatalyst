  ...
  return (
    <>
      ...
      <div className="mt-10 flex flex-wrap items-center justify-center gap-10">
        <MainCardImage
          title={"Nuevo coso"}
          description={"coso coso coso coso click para nuevo coso master"}
		  image={robot}
        ></MainCardImage>
		<CardBackground title={'Juan Pérez'} description={'lorem ipsum dolor sit amet akkasjk dansdjh sandoas sajdojasojojdsoajd jaosdjo skjdklad asdkj'} avatar={avatar} backgroundColor={'bg-blue-600/85'} background={background}></CardBackground>
	<TutorFollowCard name={'lolito'} username={'lolito44322'} avatar={icon}></TutorFollowCard>
	  </div>
    </>
  );
}
